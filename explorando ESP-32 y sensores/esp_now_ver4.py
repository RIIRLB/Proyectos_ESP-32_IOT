...
# Cambiamos el mensaje "ACK:" por "Recibio??:\n"
# RILB
...
DEVICE_ID = "ESP4"  # Ejemplo: este nodo es ESP4
...
peers = {
    ...
    "ESP3": b'\xa0\xb7eb\xef\xa4'              	# ---- de LYF
...
neighbors_ids = {
    ...
    "ESP2": ["ESP1", "ESP3", "ESP4"],  
    "ESP3": ["ESP2", "ESP4", "ESP1"],
    "ESP4": ["ESP1", "ESP3", "ESP2"] 	# Se actualiza para que ESP1 tenga a ESP2, ESP3 y ESP4 como vecinos
}
...
boton_cambiar = Pin(2, Pin.IN, Pin.PULL_UP)  # Botón para cambiar mensaje
