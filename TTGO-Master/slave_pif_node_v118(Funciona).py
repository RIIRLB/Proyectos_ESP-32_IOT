...
#
#  Cambios vs v11.7:
#    [NUEVO 1] MODO_SIEMPRE_DESPIERTO — flag global. Si es True, el nodo
#              nunca duerme y mantiene ESP-NOW activo continuamente.
#              Latencia de comando: ~100 ms. Consumo: ~30-60 mA.
#              Recomendado para los nodos relay del diagrama (los que
#              están entre el master y las hojas).
#    [NUEVO 2] Sincronización de RTC desde el campo "ts" del WAVE.
#              Cuando el master propaga la hora, el slave actualiza su
#              reloj y los timestamps del buffer son hora real.
#    [NUEVO 3] Dedup global de WAVEs por mid con TTL.
#              Antes solo deduplicaba dentro del ciclo. Si la misma
#              WAVE llegaba en dos ciclos consecutivos por culpa de un
#              relay tardío, se procesaba dos veces. Ahora no.
#    [NUEVO 4] Cuando el WAVE manda "REQ:NODE_ID" y NO somos ese nodo,
#              propagamos pero NO consumimos el sensor. Antes ya estaba,
#              pero ahora también dejamos la pantalla apagada para
#              ahorrar batería en relays.
# ============================================================
...
#          Úsalo para los relays (Slave_1, Slave_4 en tu diagrama)
#          o si todos los slaves tienen alimentación USB.
#  False → comportamiento v11.7: lightsleep cíclico, latencia hasta
#          SLEEP_MS, consumo ~bajo.
# ───────────────────────────────────────────────
MODO_SIEMPRE_DESPIERTO = True
...
def ui_bienvenida():
    ...
    modo = "SIEMPRE ON" if MODO_SIEMPRE_DESPIERTO else "v11.8 sleep"
...
if MODO_SIEMPRE_DESPIERTO:
    # No apagar STA — el modo siempre-despierto necesita radio activa.
    # No usar lightsleep. Entrar al loop continuo.
    try:
