# ============================================================
#  PIF_NODE v12.2 — Plantilla Universal / LAB-ARTE
#
#  ★ ÚNICO PARÁMETRO A CAMBIAR POR DISPOSITIVO ★
#    NODE_ID = "SLAVE_XX"
#
#  Cambios vs v11.12:
#    [NUEVO 1] Dos niveles de alerta: WARN (amarillo) y CRIT (rojo).
#              Umbrales realistas para DHT11 (rango medible 0-50°C):
#                Temp WARN: 45°C  (calor anómalo, posible problema)
#                Temp CRIT: 60°C  (DHT11 fuera de rango = incidente)
#                Hum  WARN: 15%   (baja anormal, p.ej. fuego incipiente)
#              MQ135 queda configurado para uso futuro.
#    [NUEVO 2] Display en alerta CRÍTICA: pantalla roja con texto
#              "¡ALERTA!" parpadeando + sensor afectado. Auto-apaga a
#              los T_DISPLAY_ALERTA_MS (más largo que el normal, 20s).
#    [NUEVO 3] El campo "alert" en el FB ahora lleva el NIVEL como
#              string: "WARN" o "CRIT" (antes era bool true).
#              Esto permite al master/servidor distinguir gravedad.
#
#  Cambios vs v11.11:
#    [PREV CRÍTICO] Pulsación larga del botón izquierdo también
#                   funciona en modo lightsleep (con barra de progreso).
#    [PREV] Display apagado por defecto, se prende en eventos.
#    [PREV] Modo alerta con histéresis y jitter para no saturar canal.
# ============================================================
...
def ui_bienvenida():
    ...
    modo = "SIEMPRE ON" if MODO_SIEMPRE_DESPIERTO else "v12.2 sleep"
