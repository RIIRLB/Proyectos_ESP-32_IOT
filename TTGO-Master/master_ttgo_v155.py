# ============================================================
#  MASTER_TTGO v15.5 — PIF Mesh / LAB-ARTE
#
...
def ui_status(linea1, linea2="", col1=AMARILLO, col2=GRIS):
    ...
    tft.fill(NEGRO)
    tft.write(font_sm, "PIF MASTER v15.5", 4, 4,  VERDE)
...
def heartbeat():
    ...
    tft.fill(NEGRO)
    tft.write(font_sm, "Master v15.5",  4,   4,  VERDE)
...
def ui_bienvenida():
    ...
    tft.write(font_sm, "v15.5",        4,  68, AMARILLO)
