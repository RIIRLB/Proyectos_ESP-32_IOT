// ============================================================
//  MASTER_TTGO v19.1 — PIF Mesh / LAB-ARTE
//
//  Cambios vs v18.7:
...
bool conectarWifi() {
  ...
  for (int n = 0; n < N_REDES; n++) {
    ...
    // [v19.1] FIX: abortar cualquier intento previo. Sin esto el STA queda
    // "connecting" y el siguiente begin() falla con 'cannot set config',
    // por lo que NINGUNA red llega a aplicarse. disconnect(false) deja la
    // radio encendida (no rompe ESP-NOW).
