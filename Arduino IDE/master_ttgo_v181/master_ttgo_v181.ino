// ============================================================
//  MASTER_TTGO v18.1 — PIF Mesh / LAB-ARTE
...
bool consultarHttp() {
  ...
  if (!cmds || cmds.size() == 0) {
    // Log silencioso cada 30s para confirmar que el polling funciona
